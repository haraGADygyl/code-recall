...
CodeRecall is a terminal-based flashcard application that uses OpenAI or local LLMs (via Ollama) to generate multiple-choice questions from curated technical topic catalogs. Built with Textual for the TUI and Pydantic for configuration.
...
- **`code_recall/content.py`** - Typed topic catalog loading
